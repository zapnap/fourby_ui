// Generated by @wagmi/cli@1.3.0 on 9/23/2023 at 12:06:18 AM
import {
  useContractRead,
...
export const fourbyNftAddress = {
  31337: '0x837a41023CF81234f89F956C94D676918b4791c1',
} as const
...
>(
  ...
  return useContractRead({
    abi: fourbyNftABI,
    address: fourbyNftAddress[31337],
    ...config,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link fourbyNftABI}__ and `functionName` set to `"baseUri"`.
 *
 *
 */
export function useFourbyNftBaseUri<
